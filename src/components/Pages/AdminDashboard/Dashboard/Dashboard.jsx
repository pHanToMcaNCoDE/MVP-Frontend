      ...
      <div className='gap-[24px] py-[16px] px-[32px] flex flex-col justify-center items-start self-stretch'>
        ...
        <div className='flex justify-center items-start gap-[16px]'>
            <button className='px-2 py-0 w-[140px] h-[40px] bg-[#2F4EED] flex justify-center items-center text-white rounded-[50px]'>
              Send <RxArrowTopRight />
            </button>
            <button className='px-2 py-0 w-[140px] h-[40px] bg-[#2F4EED] flex justify-center items-center text-white rounded-[50px]'>
              Receive <RxArrowBottomLeft />
            </button>
        </div>
      </div>
      <div className='py-[16px] px-0 gap-[10px] flex flex-col justify-center items-start self-stretch border-b border-[#E9E9E9]'>
        <div className='gap-[24px] flex items-start px-[32px] py-0 self-stretch'>
          <h1>Assets</h1>
          <h1>Transactions</h1>
        </div>
      </div>
